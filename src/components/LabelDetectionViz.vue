<template>
  <div class="label-detection-container">
    ...
    <div class="data-warning" v-if="detected_labels.length == 0">
    ...
    <transition-group name="segments" tag="div">
      ...
      >
        ...
        <div class="segment-timeline">
          <div
            class="segment"
            v-for="segment in label.segments"
  ...
  computed: {
    ...
    detected_labels() {
      ...
      for (
        ...
        if (
          "shot_label_annotations" in this.json_data.annotation_results[index]
        )
