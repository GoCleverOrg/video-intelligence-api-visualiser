<template>
    <div class="object-tracking-container">
        <div class="confidence">
            ...
            <input type="range" min="0.0" max="1" step="0.01" v-model="confidence_threshold">
        ...
        <transition-group name="segments" tag="div">
            <div class="segment-container" v-for="(segments, key) in object_track_segments" :key="key + 'z'">
