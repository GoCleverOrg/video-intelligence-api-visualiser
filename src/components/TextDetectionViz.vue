<template>
  <div class="object-tracking-container">
    ...
    <div class="data-warning" v-if="text_tracks.length == 0">
    ...
    <div class="current_labels">
      ...
      <div
        v-for="text in indexed_text_tracks"
        :key="text.id"
        v-if="text.has_frames_for_time(current_time)"
      >
        {{ text.text }}
      </div>
    </div>
    ...
    <div>
      ...
      <div class="text-detected" v-for="text in indexed_text_tracks">
        ...
        <span
          ...
          @click="segment_clicked(segment.start_time)"
        >
